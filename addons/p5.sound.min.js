  ...
  h = (function() {
    ...
    ;(t.prototype.set = function(e, i, n) {
      ...
      Object.defineProperty(t.prototype, 'numberOfInputs', {
        get: function() {
          return this.input
            ? this.isArray(this.input) ? this.input.length : 1
            : 0
        }
      }),
      Object.defineProperty(t.prototype, 'numberOfOutputs', {
        get: function() {
          return this.output
            ? this.isArray(this.output) ? this.output.length : 1
            : 0
        }
      }),
    ...
    return (
        ...
        return this.isNumber(e)
          ...
          : this.isUndef(e)
            ...
            : this.isString(e)
              ...
              : e instanceof t.TimeBase ? e.toSeconds() : void 0
      }),
      ...
      (t.prototype.toTicks = function(e) {
        return this.isNumber(e) || this.isString(e)
          ...
          : this.isUndef(e)
            ? t.Transport.ticks
            : e instanceof t.TimeBase ? e.toTicks() : void 0
      }),
      t
    )
  })(h, m, y, v)
    ...
    ;(e.inputSources = []),
      ...
      (t.AudioIn.prototype.start = function(t, i) {
        ...
        var o = e.inputSources[n.currentSource],
          r = {
            audio: {sampleRate: e.audiocontext.sampleRate, echoCancellation: !1}
          }
